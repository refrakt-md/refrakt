...
- Updated dependencies [0d3ebed]
  ...
  - @refrakt-md/skeleton@0.33.0

## 0.32.0

### Minor Changes

- 60a3152: Make `prominence` reach every rune, and ramp it relative to the rune's resting title size (WORK-538)
