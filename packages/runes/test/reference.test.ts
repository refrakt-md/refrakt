...
describe('describeRune — attribute tiers', () => {
	it('separates own, preset-inherited, and universal attributes', () => {
		...
		expect(out).toContain('Universal attributes (available on every rune): tint, tint-mode, bg, width, spacing, inset, elevation, frame, frame-aspect, frame-displace, frame-offset, frame-oversize, frame-place, frame-anchor, frame-shadow, substrate, substrate-size, substrate-opacity, substrate-fill, substrate-target.');
