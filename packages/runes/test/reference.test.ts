...
describe('describeRune — attribute tiers', () => {
	it('separates own, preset-inherited, and universal attributes', () => {
		...
		expect(out).toContain('Universal attributes (available on every rune): tint, tint-mode, bg, width, spacing, inset, elevation, prominence, reveal, stagger, frame, frame-aspect, frame-displace, frame-displace-mode, frame-offset, frame-oversize, frame-place, frame-anchor, frame-shadow, substrate, substrate-size, substrate-opacity, substrate-fill, substrate-target, bg-gradient, bg-from, bg-to, bg-via, bg-gradient-type, scrim, scrim-type, scrim-strength, scrim-blur, scrim-tone.');
