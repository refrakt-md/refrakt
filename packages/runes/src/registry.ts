...
export const schema = {
  ...
  Figure: useSchema(Figure).defineType('Figure', {}, 'ImageObject'),
  Gallery: useSchema(Gallery).defineType('Gallery', {}, 'ImageGallery'),
  Accordion: useSchema(Accordion).defineType('Accordion', {}, 'FAQPage'),
  AccordionItem: useSchema(AccordionItem).defineType('AccordionItem', {}, 'Question'),
  TableOfContents: useSchema(TableOfContents).defineType('TableOfContents'),
  Embed: useSchema(Embed).defineType('Embed', {}, 'VideoObject'),
  Breadcrumb: useSchema(Breadcrumb).defineType('Breadcrumb', {}, 'BreadcrumbList'),
  BreadcrumbItem: useSchema(BreadcrumbItem).defineType('BreadcrumbItem', {}, 'ListItem'),
  Budget: useSchema(Budget).defineType('Budget', {}, 'ItemList'),
  ...
  DataTable: useSchema(DataTable).defineType('DataTable', {}, 'Dataset'),
