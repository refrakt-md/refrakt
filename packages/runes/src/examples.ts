...
export const RUNE_EXAMPLES: Record<string, string> = {
	...
	"gallery": "{% gallery %}\n![Oak tree in summer](https://assets.refrakt.md/oak-tree-summer.png)\n![Oak tree in winter](https://assets.refrakt.md/oak-tree-winter.png)\n![Oak tree at dawn](https://assets.refrakt.md/oak-tree-dawn.png)\n{% /gallery %}",
