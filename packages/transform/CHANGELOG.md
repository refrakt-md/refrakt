...
- 0348f37: Fix the top-level `validation` config shorthand, which was declared everywhere
  but read nowhere.
  ...
  Note that the shorthands are the _flat shape_ — they apply to a config with no
