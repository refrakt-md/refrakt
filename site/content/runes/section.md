...
A generic page section: a short **header** — eyebrow, headline, blurb (and an optional image) — above an **arbitrary body**. Use it to introduce any content block with a title and intro, especially primitives that have no header of their own like [`bento`](/runes/bento), a grid of [cards](/runes/card), or a [collection](/runes/collection).
