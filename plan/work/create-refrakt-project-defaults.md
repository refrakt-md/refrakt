{% work id="WORK-052" status="ready" priority="medium" complexity="simple" tags="create-refrakt, packages" %}
...
- [ ] `create-refrakt` prompts for project type (or accepts it as an argument)
